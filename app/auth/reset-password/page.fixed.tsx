              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    disabled={isLoading || (searchParams && !!searchParams.get("id"))}
                    readOnly={searchParams && !!searchParams.get("id")}
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    disabled={isLoading || (searchParams && !!searchParams.get("token"))}
                    readOnly={searchParams && !!searchParams.get("token")}
                    required
                  />
                  <p className="text-xs text-muted-foreground mt-1">
